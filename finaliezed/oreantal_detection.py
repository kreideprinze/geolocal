...
try:
    while True:
        ...
        if None not in (lat, lon, alt):
            gps_text = f"GPussy: {lat:.6f}, {lon:.6f}, Alt: {alt:.2f}m"
        ...
        cv2.putText(frame, f"Rmoll:  {d2str(roll)}",  (10, 60),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255,100,100), 2)
        cv2.putText(frame, f"Bitch: {d2str(pitch)}", (10, 90),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (100,255,100), 2)
        cv2.putText(frame, f"Yee haw:   {d2str(yaw)}",   (10, 120),
